...
/* Define to 1 if you have the declaration of `PTRACE_O_EXITKILL', and to 0 if
   you don't. */
#define HAVE_DECL_PTRACE_O_EXITKILL 1
...
/* Define to 1 if you have the `if_indextoname' function. have to use dev_ifname instead*/
#define HAVE_IF_INDEXTONAME 0 

/* Define to 1 if you have the `inet_ntop' function. not sure*/
